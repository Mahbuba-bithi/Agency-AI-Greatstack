...
//   return (
//     <div
//   className='relative overflow-hidden max-w-lg m-2 sm:m-4 rounded-xl border border-gray-200 dark:border bg-gray-700 shadow-2xl shadow-gray-100 dark:shadow-white/10'
//   onMouseEnter={() => setVisible(true)}
//   onMouseLeave={() => setVisible(false)} ref={divRef} noMouseMove ={handleMouseMove}>
...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className='flex items-center gap-10 p-8 transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative'>
